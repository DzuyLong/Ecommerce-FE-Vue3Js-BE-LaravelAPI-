           ...
           <div class="grid grid-cols-1 col-span-7">
            ...
            <div class="grid grid-cols-1 col-span-5 gap-3 mt-[20px] pl-9 font-mono">
              ...
              <div class="price-product border-b-[1px] border-slate-300 flex justify-between">
                <span class="text-3xl font-bold text-red-600">{{ $filters.currencyUSD(productDetail.price) }}</span>
              ...
              <div class="flex justify-between">
                <div class="flex justify-evenly items-center border border-neutral-300 rounded-md w-[160px] h-[50px] bg-white">
                ...
                <div class="text-field-value-quantity border border-slate-300 rounded-md mx-1">
                  <input min="1" v-model="currentValue" class="h-[36px] w-[41px] text-center text-field-input p-[5px] font-semibold"/>
                </div>
